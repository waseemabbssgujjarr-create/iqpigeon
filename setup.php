<?php
/**
 * One-time database installer — run once at /setup.php, then delete this file.
 * (The /install/ folder is blocked by .htaccess for security.)
 */
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        $messages[] = 'IMPORTANT: Delete setup.php from the server root immediately after setup.';
    ...
    <div class="w-full max-w-md bg-surface-container-lowest rounded-2xl p-lg border border-outline-variant shadow-lg">
        ...
        <?php else: ?>
            <p class="text-body-md text-on-surface-variant mb-lg">
                ...
                Run this only once, then delete <code>setup.php</code> from your server.
            </p>
            <form method="POST">
